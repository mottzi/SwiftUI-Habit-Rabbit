...
//================================================================================
// 3. Presentation View: The refactored Dashboard UI.
//================================================================================
extension Habit {
    /// The Dashboard view is now a pure presentation view. It receives its state
    /// and logic from the `manager` and is responsible only for displaying the UI.
